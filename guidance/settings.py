...
SECRET_KEY = 'django-insecure-ss^rr9uvp^_m2!l@civ+=j+^(b7or08o63tfw%gm7vbmr0bngs'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv("DEBUG") == "True"

ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "guidanceai.me,www.guidanceai.me,127.0.0.1").split(",")
...
# Ensure your images folder is included
STATICFILES_DIRS = [
...
#Media Cha Vishay
MEDIA_URL = '/media/'
MEDIA_ROOT = '/var/www/guidance/media/'
